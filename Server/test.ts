...
let interval = setInterval(function(){
  ...
  monsstorrm.paragon.renderer.skeleton.bones.children.BodyLigament.children.BodyBone.children.Leftmount.children.Leftstub.deg = 35*Math.sin(songslice/180*Math.PI)
  monsstorrm.paragon.renderer.skeleton.bones.children.BodyLigament.children.BodyBone.children.Rightmount.children.Rightstub.deg = -35*Math.sin(songslice/180*Math.PI)
  monsstorrm.paragon.renderer.skeleton.bones.children.BodyLigament.children.BodyBone.children.Leftheadmount.children.Leftheadstub.deg = 10*Math.sin(songslice/180*Math.PI)
  monsstorrm.paragon.renderer.skeleton.bones.children.BodyLigament.children.BodyBone.children.Rightheadmount.children.Rightheadstub.deg = -10*Math.sin(songslice/180*Math.PI)
  monsstorrm.paragon.renderer.skeleton.bones.children.BodyLigament.children.BodyBone.deg = 30*Math.sin(songslice/180*Math.PI)
  let x = -10*Math.sin(songslice/180*Math.PI)
  monsstorrm.paragon.renderer.skeleton.bones.children.BodyLigament.x = x
  monsstorrm.paragon.renderer.skeleton.bones.children.BodyLigament.y = -20*Math.cos(x/60*Math.PI)+55
